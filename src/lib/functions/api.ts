...
const figuresOfSpeech: FigureOfSpeech[] = [
  ...
  },
  {
    name: 'Alitération',
    description: `
    L'alitération est la répétition d'une ou de plusieurs consonnes ou plus
    généralement d'un même son consonne.
    `,
    goal: `
    Le sens de la répétition du son se trouve dans le contexte dans lequel il
    est utilisé. Par exemple, pour décrire un éboulement, un son [r] répété
    ...
    examples: [
      ...
      {
        text: `
        (...) l'onde de choc fractura le fémur d'enceinte et le
        vent sabla cru le village à travers les jointures béantes du granit.
        Sous mon casque, le son atroce du roc poncé perce, mes dents vibrent -
      ...
      {
        text: `Tamtam sculpté, tamtam tendu qui gronde sous les doigts du vainqueur.`,
        source: 'Léopold Sédar Senghor, La femme noire',
      },
    ],
    sources: [
      {
        name: 'Wikipédia',
        href: 'https://fr.wikipedia.org/wiki/Alitération',
      },
      {
        name: 'La Culture Générale',
        href: 'https://www.laculturegenerale.com/alliteration-definition-exemples/',
      },
    ],
  },
];
