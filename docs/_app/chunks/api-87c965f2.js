const s=[{name:"Antanaclase",description:`
    ...
    `,examples:["J'esp\xE8re, que dis-je ? Je suis s\xFBr qu'on vous rendra justice.","Votre prudence ou plut\xF4t votre l\xE2chet\xE9 nous ont perdu."],sources:[{name:"Wikipedia",href:"https://fr.wikipedia.org/wiki/\xC9panorthose"},{name:"Wiktionnaire",href:"https://fr.wiktionary.org/wiki/\xE9panorthose"}]}],n=(r=void 0)=>{let e=s;return r&&(e=e.filter(a=>a.name===r)),e.sort((a,i)=>a.name.localeCompare(i.name))};export{n as g};
