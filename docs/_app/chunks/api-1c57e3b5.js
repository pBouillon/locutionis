const i=[{name:"Antanaclase",description:`
    ...
    `,goal:`
    Il s'agit d'une figure de style qui se pr\xEAte tr\xE8s bien aux jeux de mots,
    elle est donc fr\xE9quemment utilis\xE9e pour faire de l'humour.
    ...
    `,examples:[{text:"Le c\u0153ur a ses raisons que la raison ne conna\xEEt point.",source:"Pascal"},{text:"Adieu, monsieur l'homme d'affaires, qui n'avez fait celles de personne.",source:"Marivaux, Madame Argante I, X, La M\xE8re confidente"},{text:"Les \xE9tudiants, c'est comme le linge, quand il fait beau, \xE7a s\xE8che."}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Antanaclase"},{name:"Larousse",href:"https://www.larousse.fr/dictionnaires/francais/antanaclase/10911044"},{name:"La Culture G\xE9n\xE9rale",href:"https://www.laculturegenerale.com/antanaclase-diaphore-definition-exemples/"}]},{name:"Comparaison",description:`
    ...
    comparant).
    `,goal:`
    En mettant deux termes sur le m\xEAme plan litt\xE9raire, la comparaison permet de
    souligner leurs points communs pour imager ses propos.
    `,examples:[{text:"Et cette terre \xE9tait proche, et elle lui apparaissait comme un bouclier sur la mer sombre.",source:"Hom\xE8re, L'Odyss\xE9e, Chapitre 5"},{text:"Tu es fait comme un rat!"},{text:"Sa barbe \xE9tait d'argent comme un ruisseau d'avril.",source:"Victor Hugo, Booz endormi"}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Comparaison_(rh\xE9torique)"},{name:"La langue fran\xE7aise",href:"https://www.lalanguefrancaise.com/linguistique/la-comparaison-figure-de-style"},{name:"alloprof",href:"https://www.alloprof.qc.ca/fr/eleves/bv/francais/la-comparaison-f1369"},{name:"Youtube - Point Culture",href:"https://youtu.be/ByDNEsBNf24?t=478"}]},{name:"\xC9panorthose",description:`
    L'\xE9panorthose est une figure de style qui consiste \xE0 corriger ses propres
    propos afin d'accentuer ce qu'il vient d'\xEAtre affirm\xE9, renfor\xE7ant ainsi le
    sentiment exprim\xE9.
    `,goal:`
    Il s'agit d'une figure de style souvent utilis\xE9e pour donner un sentiment de
    sinc\xE9rit\xE9 dans son discours. En se corrigeant, le locuteur donne l'impression
    de rechercher la pr\xE9cision.
    `,examples:[{text:"J'esp\xE8re, que dis-je ? Je suis s\xFBr qu'on vous rendra justice.",source:"Jean-Baptiste Chassignet, Mespris de la vie et consolation contre la mort"},{text:"Votre prudence ou plut\xF4t votre l\xE2chet\xE9 nous ont perdu."}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/\xC9panorthose"},{name:"Wiktionnaire",href:"https://fr.wiktionary.org/wiki/\xE9panorthose"}]},{name:"M\xE9taphore",description:`
    Une m\xE9taphore est similaire \xE0 une comparaison \xE0 la diff\xE9rence pr\xE8s qu'elle
    ...
    rapproch\xE9s pour cr\xE9er cette image.
    `,goal:`
    ...
    verre.
    `,examples:[{text:"J'ai ab\xEEm\xE9 la plume de mon stylo en appuyant trop fort."},{text:"Les ailes de cet avion sont sales !"},{text:"Le pied de la table a \xE9t\xE9 rong\xE9 par les thermites."}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Catachr\xE8se"},{name:"Larousse",href:"https://www.larousse.fr/dictionnaires/francais/catachr%C3%A8se/13695"},{name:"Wiktionnaire",href:"https://fr.wiktionary.org/wiki/catachr%C3%A8see"}]},{name:"Chleuasme",description:`
    ...
    `,examples:[{text:"Je ne suis vraiment pas beau ce matin ..."},{text:"Je ne ma\xEEtrise pas tr\xE8s bien le sujet mais je peux quand m\xEAme regarder."}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Chleuasme"}]},{name:"Hyperhypotaxe",description:`
    ...
    `,examples:[{text:`Martial est fils de noble, puisque son p\xE8re est quasi-baron, \xE9tant donn\xE9
    ...
    `,examples:[{text:"Vous n'\xEAtes point gentilhomme, vous n'aurez pas ma fille.",source:"Moli\xE8re, Le Bourgeois Gentilhomme, Sc\xE8ne XII"},{text:"Il faisait beau. Le Soleil illuminait la pi\xE8ce. Au dehors, le chant des oiseaux r\xE9sonnait dans la clairi\xE8re."}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Parataxe"},{name:"La Culture G\xE9n\xE9rale",href:"https://www.laculturegenerale.com/parataxe-definition-simple-exemples/"}]},{name:"Antonomase",description:`
    ...
    sp\xE9cifique.
    `,examples:[{text:"J'irais acheter des sandwichs pour notre pique-nique de demain midi."},{text:"L'Arc de Triomphe a \xE9t\xE9 r\xE9nov\xE9."},{text:"Peux-tu me passer le Sopalin ?"},{text:"Encore un rendez-vous amoureux ? Quel Don Juan !"}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Antonomase"},{name:"Larousse",href:"https://www.larousse.fr/dictionnaires/francais/antonomase/4354"},{name:"Youtube - Point Culture",href:"https://youtu.be/ByDNEsBNf24?t=1278"}]},{name:"Pr\xE9t\xE9rition",description:`
    ...
    `,examples:[{text:"Je n'ai pas besoin de te rappeler que je dois envoyer ce document ce soir."},{text:"Je ne vous dirais pas que le co\xFBt de la vie est trop \xE9lev\xE9 (...)"},{text:"Madame Y, pour ne pas la citer, (...)"}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Pr\xE9t\xE9rition"},{name:"La Culture G\xE9n\xE9rale",href:"https://www.laculturegenerale.com/preterition-definition-exemples/"}]},{name:"Litote",description:`
    ...
    `,examples:[{text:"Pas mauvais ce repas !"},{text:"Vous n'\xEAtes pas sans savoir (...)"},{text:"\xC7a n'\xE9tait pas le match du si\xE8cle."}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Litote"},{name:"Youtube - Point Culture",href:"https://youtu.be/ByDNEsBNf24?t=207"}]},{name:"Euph\xE9misme",description:`
    ...
    `,examples:[{text:"La Russie a engag\xE9 une op\xE9ration militaire sp\xE9ciale en Ukraine."},{text:"Je ne roule pas sur l'or."},{text:"Il a pass\xE9 l'arme \xE0 gauche il y a trois ans."}],sources:[{name:"Wikip\xE9dia",href:"https://fr.wikipedia.org/wiki/Euph\xE9misme"},{name:"Youtube - Point Culture",href:"https://youtu.be/ByDNEsBNf24?t=207"},{name:"Office qu\xE9b\xE9cois de la langue fran\xE7aise",href:"http://bdl.oqlf.gouv.qc.ca/bdl/gabarit_bdl.asp?id=3202"}]},{name:"M\xE9talepse",description:`
